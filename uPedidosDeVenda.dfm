object frmPedidosDeVenda: TfrmPedidosDeVenda
  ...
  object StatusBar1: TStatusBar
    ...
    Panels = <
      item
        Alignment = taCenter
        Text = 'F2 : Consultar lista de clientes'
        Width = 200
      end
      item
        Alignment = taCenter
        Text = 'F3 : Consultar lista de produtos'
        Width = 200
      end
      item
        Width = 50
  ...
  object MainMenu1: TMainMenu
    ...
    object Opes1: TMenuItem
      ...
      object miConsultarClientes: TMenuItem
        Caption = 'Consultar Clientes'
        ShortCut = 113
        OnClick = miConsultarClientesClick
      end
      object miConsultarProdutos: TMenuItem
        Caption = 'Consultar Produtos'
        ShortCut = 114
        OnClick = miConsultarProdutosClick
      end
      object N1: TMenuItem
        Caption = '-'
      end
